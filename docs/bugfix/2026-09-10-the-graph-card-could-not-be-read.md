...
生产端到端复测发现 `rescale()` 的一个遗漏：读者操作过图谱之后再打开详情面板，画布形状变了，节点会缩小到 12.8px / 9.9px。原因、对照实验和修复见 [2026-09-11-nodes-shrank-after-the-reader-touched-the-graph.md](2026-09-11-nodes-shrank-after-the-reader-touched-the-graph.md)。
